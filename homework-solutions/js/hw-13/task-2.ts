...
function validatePassword(password: string): boolean {
  if (
    password.length < 8 || // Проверка на длину
    !/[A-Z]/.test(password) || // Проверка на заглавную букву
    !/[a-z]/.test(password) || // Проверка на строчную букву
    !/\d/.test(password) || // Проверка на цифру
    password.trim().length === 0 // Проверка на пробелы
  ) {
    return false;
  }
  return true;
